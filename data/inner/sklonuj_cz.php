...
/**
  Copyright (c) 2009-2013 Pavel Sedlák, lehce upraveno 2022 Tomáš Sourada.
...
//
	public function Sklonuj($text, $zivotne = false, $preferovanyRod = '')
	{
...
//  }
		...
		if ($ii < 0)
		{
			...
			return -1;  //    return "n  Sorry, nenasel jsem $this->vzor.";
		}
...
// Code added by Tomas Sourada:

$x=new Sklonovani();
$slova = $argv;
$removed = array_shift($slova);

foreach ($slova as $key => $slovo) {
    $tvary=$x->Sklonuj($slovo, $zivotne=false, $preferovanyRod='');
	foreach( $tvary as $element ) {
		echo $element;
	}
	echo ";";
}