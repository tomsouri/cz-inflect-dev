...
#Překopírované importy z lemmatizer_atnn
...
#Toto jsem přidal z lemmatizer_atnn:
...
# ---- POUŽIJU LEMMATIZER Z lemmatizer_atnn - class Model PŘEKOPÍROVÁNA
...
def main(args: argparse.Namespace) -> None:
    ...
    # ---- POUŽIJME main metodu Z lemmatizer_atnn
    ...
    class ShowIntermediateResults(tf.keras.callbacks.Callback):
        ...
        def on_train_batch_end(self, batch, logs=None):
            if model.optimizer.iterations % 100 == 0:
