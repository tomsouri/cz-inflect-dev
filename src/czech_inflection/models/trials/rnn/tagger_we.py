...
class Model(tf.keras.Model):
    def __init__(self, args: argparse.Namespace, train: MorphoDataset.Dataset) -> None:
        ...
        mapped = train.forms.word_mapping(words)
        ...
        embedded = tf.keras.layers.Embedding(input_dim=train.forms.word_mapping.vocabulary_size(), output_dim=args.we_dim)(mapped)
