...
# Path to config file
CONFIG=configs/rnn2.yaml

# Model
NAME="LSTM_v0.38_2_lay+batch32+emb64+brnn_enc+hid_150"
...
CHECKPOINT_PATH="data/log/evaluate_models/onmt/experiments/LSTM_v0.38_2_lay+batch32+emb64+brnn_enc+hid_150_Mon_May_22_23:32:24_CEST_2023/model/LSTM_v0.38_2_lay+batch32+emb64+brnn_enc+hid_150_step_1700000.pt"
